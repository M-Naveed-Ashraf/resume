...
\begin{center}
    \medskip
    \textit{
        \cfontsize{14pt}4+ years building production web platforms (React, Next.js, Python) with strong cloud (AWS/Azure) and data skills. \\
        Led an AI time-series forecasting initiative (Pakistan equities): end-to-end architecture, hiring, pipelines, training, and deployment. \\
